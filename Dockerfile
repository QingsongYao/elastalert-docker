...
# URL from which to download Elastalert. Temporary point to private ES5 support branch's download until the change of support ES5 was checked-in into main
